...
class Condition(json_base_class.Json_base):
    ...
    def test():
        ...
        if(test_condition == new_condition):
            ...
            print("There was an error storing and loading the condition, the objects are not identical")
            print(test_condition.__dict__, new_condition.__dict__, sep='\n\n\n\n\n\n\n\n')
            return False
    ...
    def __init__(self, rxn_temp, species, reagents, reagent_temp_list, reagent_conc_list, molecule_conc_list, *args, **kw_args):
    ...
    def prepare_store(self):
        prepared_dict =  {  'reaction_temperature'       : self.reaction_temperature,
