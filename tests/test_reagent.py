...
def test_init():
    ...
    want = {
        ...
        'coefficient_array': np.array([[1., 1., -1.], [-1., 2., -1.]]),
        'reactant_coefficient_array': np.array([[0., 0., 1.], [1., 0., 1.]]),
        'product_coefficient_array': np.array([[1., 1., 0.], [0., 2., 0.]])
    }
